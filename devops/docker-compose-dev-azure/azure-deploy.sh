...
resourcename="hyper-hegel"  # lower case, only
resourcegroup="hyper-hegel_rg"
...
# git clone https://github.com/apilogicserver/hyper-hegel.git
# cd hyper-hegel
...
az group create --name hyper-hegel_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group hyper-hegel_rg --sku S1 --is-linux
az container create --resource-group hyper-hegel_rg --name hyper-hegel --image apilogicserver/hyper-hegel:latest --dns-name-label hyper-hegel --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//hyper-hegel.westus.azurecontainer.io:5656'
