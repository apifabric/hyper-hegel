...
@Component({
  selector: 'QuoteCategory-home',
  templateUrl: './QuoteCategory-home.component.html',
  styleUrls: ['./QuoteCategory-home.component.scss']
})
export class QuoteCategoryHomeComponent implements AfterViewInit {
